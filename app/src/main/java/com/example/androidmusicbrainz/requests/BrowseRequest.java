...
public class BrowseRequest {
    ...
    protected String browseEntity;
    protected IBrowseRequest ui;

    public BrowseRequest(Context context, String resultEntity, String browseEntity, IBrowseRequest ui) {
        this.context = context;
        this.resultEntity = resultEntity;
        this.browseEntity = browseEntity;
        this.ui = ui;
    }

    public void makeRequest(String mbid){
        String url = BASE_URL + this.resultEntity + "?" + this.browseEntity + "=" + mbid + "&fmt=json&limit=25";
        this.callVolley(url);
    }
    ...
    public interface IBrowseRequest{
